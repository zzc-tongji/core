package io.github.messagehelper.core.rule._if.wechatconnector.listener.wechat;
...
public class Message extends RuleIf {
  ...
  public boolean satisfy(Log log) {
    ...
    if (!(content
        instanceof
        io.github.messagehelper.core.log.content.wechatconnector.listener.wechat.Message)) {
      return false;
    }
    io.github.messagehelper.core.log.content.wechatconnector.listener.wechat.Message message =
        (io.github.messagehelper.core.log.content.wechatconnector.listener.wechat.Message) content;

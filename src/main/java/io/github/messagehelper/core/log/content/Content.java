package io.github.messagehelper.core.log.content;
  ...
  public static Content parse(String category, String json) {
    ...
    switch (category) {
      case "wechat-connector.cache.get":
        return new io.github.messagehelper.core.log.content.wechatconnector.cache.Get(json);
      case "wechat-connector.cache.set":
        return new io.github.messagehelper.core.log.content.wechatconnector.cache.Set(json);
      case "wechat-connector.listener.http.listen":
        return new io.github.messagehelper.core.log.content.wechatconnector.listener.http.Listen(
            json);
      case "wechat-connector.listener.wechat.error":
        return new io.github.messagehelper.core.log.content.wechatconnector.listener.wechat.Error(
            json);
      case "wechat-connector.listener.wechat.friendship":
        return new io.github.messagehelper.core.log.content.wechatconnector.listener.wechat
            .Friendship(json);
      case "wechat-connector.listener.wechat.message":
        return new io.github.messagehelper.core.log.content.wechatconnector.listener.wechat.Message(
            json);
      ...
      case "wechat-connector.requestor.wechat.error":
        return new io.github.messagehelper.core.log.content.wechatconnector.requestor.wechat.Error(
            json);
      case "wechat-connector.requestor.wechat.forward":
        return new io.github.messagehelper.core.log.content.wechatconnector.requestor.wechat
            .Forward(json);
      case "wechat-connector.requestor.wechat.reply":
        return new io.github.messagehelper.core.log.content.wechatconnector.requestor.wechat.Reply(
            json);
      case "wechat-connector.requestor.wechat.send":
        return new io.github.messagehelper.core.log.content.wechatconnector.requestor.wechat.Send(
            json);
      case "wechat-connector.requestor.wechat.sync":
        return new io.github.messagehelper.core.log.content.wechatconnector.requestor.wechat.Sync(
            json);
      default:
